...
class IngestionValidation:
    ...
    def _validate_files_numbers(self, expected_total_responses: int) -> int:
        ...
        print(f"Total de registros esperado da API: {expected_total_responses}")
        ...
        for key in files:
            ...
            if data:
                ...
                responses_per_file.append(num_records)
                total_responses += num_records
                print(f"Arquivo: {key} | Registros no arquivo: {num_records}")

        print(f"Total de registros encontrados nos arquivos JSON: {total_responses}")
    ...
    def validation_execute(self) -> int:
        ...
        print("Executando validação de ingestão com controle:")
        print(f"Registros totais esperados (API): {total_records_api}")
        ...
        print(f"Resultado da validação de quantidade: {var_validation_ingestion_1}")
        print(f"Resultado da validação de tipo: {var_validation_ingestion_2}")
